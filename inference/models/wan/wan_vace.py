...
global Client
import io
def load_full_acc_model(checkpoint_dir):
    #acc_model_path = "models/vdot_14b.pt"
    acc_model_path = os.path.join(checkpoint_dir, "vdot-weights/vdot_14b.pt")
    ...
    config_path = "inference/models/wan/vace-14b-config.json"
...
class WanVace(WanT2V):
    def __init__(
        ...
        self.model = load_full_acc_model(checkpoint_dir)
